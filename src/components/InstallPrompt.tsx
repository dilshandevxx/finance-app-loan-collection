  ...
  return (
    <div className="fixed bottom-24 sm:bottom-6 left-1/2 -translate-x-1/2 w-[calc(100%-2rem)] max-w-sm bg-gray-900 text-white dark:bg-neutral-900 border border-gray-800 dark:border-neutral-800 rounded-2xl p-5 shadow-2xl z-[10000] animate-in slide-in-from-bottom-8 duration-500">
      ...
      <div className="flex gap-4 items-start pr-6">
        <div className="w-12 h-12 bg-emerald-600 rounded-xl flex items-center justify-center shrink-0 shadow-lg">
      ...
      {platform === "android" && (
        <div className="flex gap-2.5 mt-2">
          ...
          <button
            ...
            className="flex-[2] h-10 text-xs font-bold bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl transition-all active:scale-95 shadow-md flex items-center justify-center gap-1.5"
          >
