...
export function BigPortfolioHeader({ loans }: BigPortfolioHeaderProps) {
  ...
  return (
    <div className="w-full relative rounded-[2rem] overflow-hidden bg-[#0a0514] border border-white/10 shadow-2xl mb-2">
      {/* Ambient Glows */}
