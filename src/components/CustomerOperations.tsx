      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="text-xs font-bold uppercase tracking-wider text-primary bg-primary/10 px-3.5 py-1.5 rounded-xl border border-primary/20 hover:bg-primary/20 transition-all"
          >
