      ...
      <div className="flex flex-col md:grid md:grid-cols-12 gap-5 items-start">
        ...
        <div className="flex flex-col gap-5 md:col-span-7">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            {/* Overdue */}
            <div className="rounded-2xl p-5 flex flex-col gap-1 bg-gradient-to-br from-rose-400 to-rose-600 text-white shadow-[0_4px_20px_rgba(225,29,72,0.3)] relative overflow-hidden">
              <div className="absolute -top-6 -right-6 w-32 h-32 bg-white/10 rounded-full blur-2xl pointer-events-none" />
