    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-background px-4 overflow-hidden relative">
      ...
      <div className="w-full max-w-sm flex flex-col items-center z-10">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <h2 className="text-xl font-bold text-foreground tracking-tight">Hi, {config.agentName}</h2>
          <p className="text-xs text-muted-foreground mt-1 font-medium tracking-widest uppercase">LoanTrack Pro Agent</p>
        </div>
