      ...
      <main className="px-6 sm:px-12 lg:px-24 max-w-[1400px] mx-auto">
        ...
        <section className="py-24 border-b border-white/10">
          ...
          <div className="mt-32 flex flex-col items-center">
            <p className="text-[10px] font-bold uppercase tracking-widest text-white/30 mb-8">We are honored to work with leading brands</p>
        ...
        <section className="py-32 border-b border-white/10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            <div className="aspect-[4/5] bg-[#111] p-8 flex flex-col justify-between group hover:bg-[#1a1a1a] transition-colors cursor-pointer border border-white/5">
            ...
            <div className="aspect-[4/5] bg-white text-black p-8 flex flex-col justify-between group cursor-pointer hover:bg-gray-100 transition-colors">
        ...
        <footer className="pt-32 pb-12">
          <div className="flex flex-col md:flex-row justify-between items-center md:items-end gap-12 mb-32 border-b border-white/10 pb-16">
            <h2 className="text-[clamp(3.5rem,10vw,7rem)] font-bold tracking-tighter leading-none">Let's Work</h2>
            <Link href="/login/auth">
              <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full border border-white/50 flex flex-col items-center justify-center hover:bg-white hover:text-black hover:scale-105 transition-all cursor-pointer group relative overflow-hidden shrink-0">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12 text-xs font-light">
            ...
            <div className="flex flex-col gap-3">
              ...
              <p className="text-white/50">123 Colombo Road<br/>Colombo 00300, Sri Lanka</p>
            ...
            <div className="col-span-2">
              ...
              <div className="flex items-center border-b border-white/20 pb-2 focus-within:border-white transition-colors">
                ...
                <button className="hover:scale-110 transition-transform"><ArrowUpRight className="w-4 h-4 text-white hover:text-white" /></button>
              </div>
            </div>
          </div>
          
          <div className="mt-24 text-center md:text-left flex flex-col md:flex-row justify-between items-center gap-4">
